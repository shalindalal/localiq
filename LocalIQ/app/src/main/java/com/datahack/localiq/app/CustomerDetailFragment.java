...
public class CustomerDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.textCustomerName)).setText(mItem.name);
            ((TextView) rootView.findViewById(R.id.textCustomerPhoneNumber)).setText(mItem.phoneNumber);
            ((TextView) rootView.findViewById(R.id.textCustomerAddress)).setText(mItem.address);
        }
